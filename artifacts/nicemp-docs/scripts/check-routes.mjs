 ...
 *
 * WHY THIS EXISTS:
 * App.tsx and Sidebar.tsx have been rewritten wholesale during feature
 * work and silently dropped Overview, Explorer, and Glossario routes
 * multiple times. This script catches that class of regression before deploy.
 * Any agent editing App.tsx or Sidebar.tsx MUST run this check afterwards.
 */
