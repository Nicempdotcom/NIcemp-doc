...
export default function Sidebar({ isOpen, onClose }: SidebarProps) {
  return (
    <>
      ...
      {/* Sidebar */}
      <aside className={`
        fixed top-0 left-0 z-50 flex flex-col h-full w-64 bg-sidebar border-r border-sidebar-border
      ...
      `}>
        ...
        <nav className="flex-1 overflow-y-auto px-3 py-2">
          <div className="px-3 mb-1 mt-4 text-[10px] uppercase tracking-widest text-muted-foreground font-semibold">
            Documentação
          </div>
